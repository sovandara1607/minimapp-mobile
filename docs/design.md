...
Layout: safe area → compact wordmark → flexible map frame → quiet status footer. On-map status at top left, north/perspective at top right, speed low left, player at 68% of the map height, recenter at bottom center only during explore. Mapbox attribution remains visible at the bottom edge.
